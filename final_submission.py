...
# load the data colleccted from the lander game
...
# preprocessing the data(looking for missing values and duplicated data)
...
# splitting the data to train(70%), test(15%) and validation data(15%)
...
#save min and max value of the trainning data
...
#combine the input and output of the data
...
#Define the Neuron class to implement the feedforward and backpropagation process
import numpy as np
...
#initialize the neural network with hyperparameters and train the model for 100 epoch
...
# visualize the error vs epoch for trainning and validation data
...
#printing the value of weights saved for best performance
...
#finally predict and calculate the root mean squared error on test(unseen)data and evaluate the model
